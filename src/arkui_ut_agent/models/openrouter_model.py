    ...
    def _calculate_cost(self, response) -> dict[str, float]:
        ...
        if cost <= 0.0 and self.config.cost_tracking != "ignore_errors":
            raise RuntimeError(
                ...
                "(for example for free/local models), more information at https://github.com/Muilrz/Arkui-UT-Code-Agent "
                "for more details. Still stuck? Please open a github issue at https://github.com/Muilrz/Arkui-UT-Code-Agent/issues/new/choose!"
            )
        return {"cost": cost}
