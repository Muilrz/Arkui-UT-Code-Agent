...
from arkui_ut_agent.models.utils.cache_control import set_cache_control
from arkui_ut_agent.models.utils.openai_multimodal import expand_multimodal_content
from arkui_ut_agent.models.utils.retry import retry
...
class LitellmModelConfig(BaseModel):
    ...
    """Model registry for cost tracking and model metadata. See the local model guide (https://github.com/Muilrz/Arkui-UT-Code-Agent) for more details."""
        ...
        try:
            ...
            if self.config.cost_tracking != "ignore_errors":
                msg = (
                    ...
                    "https://github.com/Muilrz/Arkui-UT-Code-Agent. "
                    " Still stuck? Please open a github issue at https://github.com/Muilrz/Arkui-UT-Code-Agent/issues/new/choose!"
                )
                logger.critical(msg)
