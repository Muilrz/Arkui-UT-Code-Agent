"""Run arkui-ut-code-agent on ProgramBench instances in batch mode."""
...
_HELP_TEXT = """Run arkui-ut-code-agent on ProgramBench instances.
...
def process_instance(
    ...
    try:
        ...
        env.execute(
            {"command": 'git config user.name "arkui-ut-code-agent" && git config user.email "arkui-ut-code-agent@proton.me"'}
        )
