...
from arkui_ut_agent.models.portkey_model import PortkeyModel, PortkeyModelConfig
from arkui_ut_agent.models.utils.actions_toolcall import BASH_TOOL
...
def test_portkey_model_initialization():
    ...
    with patch("arkui_ut_agent.models.portkey_model.Portkey", mock_portkey_class):
...
def test_portkey_model_query():
    ...
    with patch("arkui_ut_agent.models.portkey_model.Portkey", mock_portkey_class):
        with patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}):
            with patch("arkui_ut_agent.models.portkey_model.litellm.cost_calculator.completion_cost") as mock_cost:
...
def test_portkey_model_cost_tracking_ignore_errors():
    ...
    with patch("arkui_ut_agent.models.portkey_model.Portkey", mock_portkey_class):
        with patch.dict(os.environ, {"PORTKEY_API_KEY": "test-key"}):
            ...
            with patch(
                "arkui_ut_agent.models.portkey_model.litellm.cost_calculator.completion_cost",
