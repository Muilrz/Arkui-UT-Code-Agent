...
from arkui_ut_agent.models.litellm_model import LitellmModel, LitellmModelConfig
...
class TestLitellmModel:
    @patch("arkui_ut_agent.models.litellm_model.litellm.completion")
    @patch("arkui_ut_agent.models.litellm_model.litellm.cost_calculator.completion_cost")
