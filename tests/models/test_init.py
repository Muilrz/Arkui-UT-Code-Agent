...
from arkui_ut_agent.models import GlobalModelStats, get_model, get_model_class, get_model_name
...
class TestGetModel:
    def test_config_deep_copy(self):
        ...
        with patch("arkui_ut_agent.models.get_model_class") as mock_get_class:
