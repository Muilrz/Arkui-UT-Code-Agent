...
def test_openrouter_model_format_error_persists_response() -> None:
    from arkui_ut_agent.models.openrouter_model import OpenRouterModel
...
def test_openrouter_response_model_format_error_persists_response() -> None:
    from arkui_ut_agent.models.openrouter_response_model import OpenRouterResponseModel
...
def test_portkey_model_format_error_persists_response(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from arkui_ut_agent.models.portkey_model import PortkeyModel
    ...
    with patch("arkui_ut_agent.models.portkey_model.Portkey"):
...
def test_portkey_response_model_format_error_persists_response_with_model_dump(
    ...
    monkeypatch.setenv("PORTKEY_API_KEY", "test-key")
    from arkui_ut_agent.models.portkey_response_model import PortkeyResponseAPIModel
    ...
    with patch("arkui_ut_agent.models.portkey_response_model.Portkey"):
...
def test_requesty_model_format_error_persists_response() -> None:
    from arkui_ut_agent.models.requesty_model import RequestyModel
...
def test_litellm_textbased_model_format_error_persists_response() -> None:
    ...
    from arkui_ut_agent.models.litellm_textbased_model import LitellmTextbasedModel
...
def test_openrouter_textbased_model_format_error_persists_response() -> None:
    ...
    must reach the parse_regex_actions code path via inherited query()."""
    from arkui_ut_agent.models.openrouter_textbased_model import OpenRouterTextbasedModel
